...
tf.flags.DEFINE_string("input_file_pattern", base_folder+"/mscoco/val-?????-of-00004",
                       "File pattern of sharded TFRecord input files.")
tf.flags.DEFINE_string("checkpoint_dir", base_folder + "/model/3m/train",
                       "Directory containing model checkpoints.")
tf.flags.DEFINE_string("eval_dir", base_folder + "/model/3m/eval", "Directory to write event logs.")
